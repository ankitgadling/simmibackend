    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cause_for_donation', models.CharField(choices=[('Women Empowerment', 'Women Empowerment'), ('HealthCare', 'HealthCare'), ('Other', 'Other'), ('Education', 'Education'), ('Livlihood', 'Livlihood')], max_length=100)),
